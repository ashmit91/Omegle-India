...
document.addEventListener('DOMContentLoaded', function() {
  ...
  noButton.onclick = function() {
      // Update the modal content to display a message
      modalContent.innerHTML = `
          <h2>Age Verification</h2>
          <p>This site is not for children.</p>
          <p>Please visit a safe site for children.</p>
          <a href="https://www.omegleindia.in/aboutus.html" class="safe-site-link">Check Rules</a>
      `;
      // Add a class to style the link
      modalContent.querySelector('.safe-site-link').style.display = 'block';
      modalContent.querySelector('.safe-site-link').style.textAlign = 'center';
      modalContent.querySelector('.safe-site-link').style.marginTop = '20px';
      modalContent.querySelector('.safe-site-link').style.color = '#4CAF50';
      modalContent.querySelector('.safe-site-link').style.textDecoration = 'none';
  }
});
