...
const showChatStartedPrompt = () => {
  const chatStartedPrompt = document.createElement('div');
  chatStartedPrompt.textContent = 'You are now chatting with a stranger';
  chatStartedPrompt.classList.add('chat-started-prompt');
 
  // Append the prompt to the appropriate container in your HTML
  const messagesContainer = document.getElementById('messages_container');
  messagesContainer.appendChild(chatStartedPrompt);
 };
